...
export const Basket = () => {
	const { products, basket, language } = useContext(AppContext)
	...
	return (
		<div className="basket">
			<div className="basket__header header">Корзина</div>
				...
				<div className="basket__content">
					...
					<div className="basket__buy">
						<div className="basket__info">
							<div className="header">ИТОГО</div>
