		...
		<div className="footer-mobile">
			...
			<div className="footer-mobile__nav">
				<div className="footer-mobile__nav-icon">
					<FooterNavigationModal
						isNavOpen={navModalIsOpen}
						onCloseModal={handleCloseNavModal}
					/>
					<button
						onClick={changeNavModal}
						type="button"
						className="footer-open-nav-modal-button"
					>
			...
			<div className="footer-mobile__lang">
				<div className="footer-mobile__nav-lang">
					<FooterLanguageModal isNavOpen={langModalIsOpen} />
					<button
						type="button"
						onClick={changeLanguageModal}
						className="footer-open-lang-modal-button"
					>
